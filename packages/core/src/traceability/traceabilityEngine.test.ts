...
const mockPaths = {
  ...
  scopeDir: "/fake/runs/run-1/scope",
  scopeDefinitionPath: "/fake/runs/run-1/scope/product-goal.md",
  outOfScopePath: "/fake/runs/run-1/scope/out-of-scope.md",
  successCriteriaPath: "/fake/runs/run-1/scope/success-criteria.md",

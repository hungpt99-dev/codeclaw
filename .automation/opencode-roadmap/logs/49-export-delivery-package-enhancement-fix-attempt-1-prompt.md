...
$ prettier --check .
Checking formatting...
[warn] apps/local-web/src/lib/types.ts
[warn] apps/local-web/src/pages/RunDetail.tsx
[warn] packages/adapters/src/export/deliveryPackage.ts
[warn] packages/adapters/src/export/exportService.ts
[warn] packages/adapters/src/index.ts

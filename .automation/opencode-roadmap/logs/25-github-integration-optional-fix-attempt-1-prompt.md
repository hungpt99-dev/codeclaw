...
apps/cli test: 📋 No specific project type detected.
apps/cli test: 🎉 codeclaw initialized successfully!
apps/cli test:  ✓ src/index.test.ts (22 tests) 1363ms
apps/cli test:    ✓ doctorCommand > passes when .codeclaw is properly initialized  961ms
apps/cli test:  Test Files  1 passed (1)
apps/cli test:       Tests  22 passed (22)
apps/cli test:    Start at  15:42:13
apps/cli test:    Duration  2.39s (transform 288ms, setup 0ms, collect 539ms, tests 1.36s, environment 0ms, prepare 85ms)
apps/cli test: Done
$ knip
Unlisted binaries (2)
which  packages/adapters/src/integrations/gitHubCliService.ts
gh     packages/adapters/src/integrations/gitHubCliService.ts

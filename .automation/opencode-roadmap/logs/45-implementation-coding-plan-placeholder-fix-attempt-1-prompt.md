...
$ prettier --check .
Checking formatting...
[warn] docs/superpowers/plans/2026-06-24-coding-plan-step.md
[warn] packages/core/src/agents/codingPlanAgent.test.ts
[warn] templates/prompts/coding-plan-agent.md
